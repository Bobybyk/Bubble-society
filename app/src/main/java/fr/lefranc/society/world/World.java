 ...
 *
 */
package fr.lefranc.society.world;

import fr.lefranc.society.collision.AABB;
import fr.lefranc.society.entity.Entity;
import fr.lefranc.society.entity.Transform;
import fr.lefranc.society.entity.WorkerDisplay;
            ...
            for (int y = 0; y < height; y++) {
                for (int x = 0; x < width; x++) {
                    ...
                    if (entityAlpha > 0) {
                        ...
                        switch (entityIndex) {
                            case 1:
                                worker = new WorkerDisplay(transform);
                                entities.add(worker);
